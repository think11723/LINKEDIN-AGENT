...
class OpenRouterProvider(BaseProvider):
    ...
    def _normalize_response(self, response_data: Dict[str, Any]) -> Tuple[str, Optional[int]]:
        """Normalize OpenRouter response to text.
    ...
    async def generate_text(self, prompt: str, **kwargs) -> LLMResponse:
        ...
        def _make_request() -> Tuple[str, Optional[int], int]:
            headers = {
                ...
                "HTTP-Referer": "https://github.com/think11723/LINKEDIN-AGENT",
            ...
            try:
                ...
                if response.status_code == 429:
                    ...
                    raise NetworkError("Invalid OpenRouter API key")
                    ...
                    raise NetworkError(f"OpenRouter API error: {response.status_code}")
                ...
                raise NetworkError(f"OpenRouter network error: {str(e)}")
